...
- **Overview**: C#, .NET Framework, Microsoft Visual Studio, Powershell, Git, OOP Principles, Input/Output streams, Async C#, LINQ, NUnit testing, Test Driven Development                       (TDD),Mocking with Moq
- **Databases**: Microsoft SQL Server, T-SQL (Transact-SQL), Basic ADO.NET, Entity Framework, Data Normalisation and Schema Design
- **Backend**: ASP.NET, MVC, Authentication in ASP.NET core, Middleware in ASP.NET core
- **Cloud**: AWS
